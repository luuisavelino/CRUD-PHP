...
<main>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td> 
              ...
              <div id="popup" class="popup" <?php echo $produto['nome']; ?>>
                <a href="javascript: fecharPopUp();">
                  <svg width="25" height="16" fill="#f00f0f" class="close" aria-label="Close">
                      <circle cx="8" cy="8" r="8"/>
                  </svg>
                </a>
                <a href="javascript: diminuirPopUp();">
                  <svg width="25" height="16" fill="yellow" class="close" aria-label="Close">

                      <circle cx="8" cy="8" r="8"/>
                  </svg>
                </a>
                  <a href="javascript: ampliarPopUp();">
                ...
                <h1 text-align="center" class="text-light"><?php echo $produto['nome'];?></h1>
                
              </div>

            <a href="javascript: abrirPopUp();" id=<?=$produto['id']?>>
  ...
  <script type="text/javascript">
    ...
    function ampliarPopUp(){
      document.getElementById('popup').style.width = '98%';
